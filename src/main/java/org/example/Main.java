...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1,"Bugra", "Han"));
        employees.add(new Employee(1,"Bugra", "Han"));
        employees.add(new Employee(1,"Bugra", "Han"));
        employees.add(new Employee(2,"mehir","han"));
        employees.add(new Employee(3,"sinek", "han"));
        employees.add(new Employee(4, "mehmet", "can"));
